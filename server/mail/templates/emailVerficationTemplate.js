const otpTemplate = (otp) => {
    ...
    <body>
        <div>
            ...
            <img src="https://i.ibb.co/7Xyj3PC/logo.png" alt="StudyNotion Logo"></a>
            <div class="message">OTP Verfication Email</div>
            <div class="body">
                <p>Dear User, </p>
                <p>Thank you for registering with StudyNotion, Please complete your registration, Please use the following OTP
