...
import LearningLanguageSection from '../components/core/HomePage/LearningLanuageSection';
  ...
  return (
    <div>
        ...
        <div className='w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-between gap-8'>
            ...
            <div className='flex flex-col mb-10 justify-between lg:mt-20 lg:flex-row lg:gap-0 mt-[-100px] gap-7'>
                ...
                <div className='flex flex-col gap-10 lg:w-[40%] items-start'>
                    ...
                    The modurn StudyNotion is the dictates its own terms. Today, to be a competitive specialist requires more than professional skils.
                    </div>
                <CTAButton active={true} linkto={"/signup"}>
                    <div>
                        Learn More
        ...
        {/* {section 3} */}
        <div className='relative w-11/12 mx-auto items-center max-w-maxContent justify-between gap-8 first-letter bg-richblack-900 text-white'>
